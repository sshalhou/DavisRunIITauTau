...
def editCondorConfig(List):
  ...
  for line in condorConfigFileTmp:
    ...
    if 'Place Input' in line:
      if '.txt' in List[2]:
        line = 'transfer_input_files = ' + os.getcwd() + '/' + List[2] + ',' + os.getcwd() + '/supportFiles/pDistPlots.root' + ',' + os.getcwd() + '/ZReweight/zpt_weights.root'+ ',' + os.getcwd() + '/HTT-utilities/QCDModelingEMu/data/QCD_weight_emu.root'+ ',' + os.getcwd() + '/HTT-utilities/QCDModelingEMu/data/QCD_weight_emu_nodzeta.root' + ',' + os.getcwd() + '/HTT-utilities/LepEffInterface/data/Muon/Run2016BCD/Muon_IdIso0p15_eff.root' + ',' + os.getcwd() + '/HTT-utilities/LepEffInterface/data/Muon/Muon_SingleMu_eff.root' + ',' + os.getcwd() + '/HTT-utilities/LepEffInterface/data/Muon/Run2016BCD/Muon_IdIso0p20_eff.root' + ',' + os.getcwd() + '/HTT-utilities/LepEffInterface/data/Electron/Run2016BCD/Electron_IdIso0p10_eff.root' + ',' + os.getcwd() + '/HTT-utilities/LepEffInterface/data/Electron/Electron_SingleEle_eff.root' + ',' + os.getcwd() + '/HTT-utilities/LepEffInterface/data/Electron/Run2016BCD/Electron_IdIso0p15_eff.root' + ',' + os.getcwd() + '/HTT-utilities/LepEffInterface/data/Muon/Muon_Mu8_fall15.root' + ',' + os.getcwd() + '/HTT-utilities/LepEffInterface/data/Muon/Muon_Mu17_fall15.root' + ',' + os.getcwd() + '/HTT-utilities/LepEffInterface/data/Electron/Electron_Ele17_fall15.root' + ',' + os.getcwd() + '/HTT-utilities/LepEffInterface/data/Electron/Electron_Ele12_fall15.root' + ',' + os.getcwd() + '/SUSYHiggsPtReweight/Reweight.root' + '\n'
      if '.root' in List[2]:
