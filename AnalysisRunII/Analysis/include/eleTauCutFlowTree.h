...
#ifndef Analysis_eleTauCutFlowTree_h
#define Analysis_eleTauCutFlowTree_h
...
public:
	eleTauCutFlowTree(FlatTreeReader, bool);
	virtual ~eleTauCutFlowTree();	
	void handleEvent();
	void finish();
