...
syncTreeAnalysis::syncTreeAnalysis(FlatTreeReader R_, bool run_)
{
	m_run = run_;
	R = R_;
...
syncTreeAnalysis::~syncTreeAnalysis()
{
...
void syncTreeAnalysis::handleEvent()
{
	// reset values
	reset();
...
void syncTreeAnalysis::setupBranches(TTree * T)
{
